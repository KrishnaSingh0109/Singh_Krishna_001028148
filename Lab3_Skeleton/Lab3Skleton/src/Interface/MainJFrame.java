...
//        ProdManagementPanel amPanel = new ProdManagementPanel(this.rightPanel);
//        this.rightPanel.add("prodManagementPanel",amPanel);
//        rightSplitPane.setRightComponent(amPanel);
        ProdManagementPanel prodManagementPanel = new ProdManagementPanel(this.rightPanel,accDir);
        CardLayout layout = (CardLayout)this.rightPanel.getLayout();
        this.rightPanel.add("prodManagementPanel", prodManagementPanel);
